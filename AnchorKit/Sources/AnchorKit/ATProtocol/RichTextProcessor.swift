...
public final class RichTextProcessor: RichTextProcessorProtocol {
    ...
    private func detectURLs(in text: String) -> [RichTextFacet] {
        ...
        let patterns = [
            "https?://[^\\s<>\"{}|\\\\^`\\[\\]()]+[^\\s<>\"{}|\\\\^`\\[\\]().,;!?]", // Full URLs, exclude trailing punctuation and parens
            "www\\.[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,}(?:/[^\\s<>\"{}|\\\\^`\\[\\]()]*)?(?![.,;!?()])" // www URLs, exclude trailing punctuation and parens
        ]
