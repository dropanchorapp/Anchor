...
public final class LocationFormatter: Sendable {
    ...
    public nonisolated func getLocationName(_ locations: [LocationRepresentable]) -> String {
    ...
    public nonisolated func getLocationAddress(_ locations: [LocationRepresentable]) -> String {
        for location in locations {
    ...
    public nonisolated func formatInlineLocationInfo(_ locations: [LocationRepresentable]) -> String {
    ...
    public nonisolated func formatGeoLocationFooter(_ locations: [LocationRepresentable]) -> String? {
    ...
    public nonisolated func extractCoordinate(from locations: [LocationRepresentable]) -> CLLocationCoordinate2D? {
        for location in locations {
